...
A 120-person, 24-hour hackathon for spatial creation.
Part of a16z LA Tech Week (Oct 12–18, 2026).
...
backgrounds (CS, ML, XR, design, film, robotics). USC, UCLA, Berkeley, and a small
alumni pool from Apple, Snap, Niantic, and the LA XR studios.

## What we need from the space
...
$5K a16z Tech Week grant secured. Vision Pro locked in as the grand prize. Sponsor
conversations open with Roboflow, XReal, Luma Labs, Snap, USC ICT, and Brilliant Labs.
...
Iana Lin (Berkeley EECS): ianalin123@berkeley.edu
