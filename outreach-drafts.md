...
| **recipient TBD** (Snap AR) | Sissi | snap hq + spectacles for an la tech week hackathon | Spectacles loaner bench + judge/mentor, Snap HQ hosting as the bigger version. Names Daniel Suh. **Overlaps the `joe.darko@snap.com` draft above (Both events section) — if Daniel names nobody, fold the venue ask into the Darko draft and trash this one. Never send both to Snap** | 08-31 |
