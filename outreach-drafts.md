...
| `daniel@goldhouse.org` | `ted@goldhouse.org`, `vanessa@goldhouse.org`, Sissi | Re: LA tech week event | Reply to his Snap HQ suggestion: asks for a Snap contact, flags the overnight, offers Gold House the **Community tier** (logo + distribution + discretionary post-demo intros, **no resume book** per Iana), asks for a 20 min call Mon/Tue | 08-31 |
| **recipient TBD** (Snap AR) | Sissi | snap hq + spectacles for an la tech week hackathon | Spectacles loaner bench + judge/mentor, with Snap HQ hosting as the bigger version. **Conditional: names Daniel Suh, so it only goes out if he says he has no contact and OKs the mention.** Fill in recipient from his answer | 08-31 |
